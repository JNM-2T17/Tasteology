...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value="resources/assets/css/font-awesome-4.4.0/css/font-awesome.min.css"/>" />
		<script src="<c:url value="resources/assets/js/script.js"/>"></script>
		<script src="<c:url value="resources/assets/js/addEditContact.js"/>"></script>
	...
	<body>
		<div id="mainContent">
			...
			<form action="addRecipe" method="POST" id="edit-contact-form" onsubmit="return checkSource('contact');">
				New Recipe: <input name="name" type="text" value="" required /><br/>
